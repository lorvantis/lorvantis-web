    ...
    with st.chat_message("assistant"):
        with st.spinner("Kailer AI düşünüyor..."):
            try:
                ...
                # Kailer AI karakter ve kural tanımı
                system_prompt = """Senin adın Kailer AI. Türkiye'nin yerli ve samimi yapay zekasısın. Kullanıcıyla hep 'kanka' diliyle konuşursun. 
